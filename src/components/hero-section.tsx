      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              The only productivity app you'll ever need. Streamline your workflow, eliminate distractions, and achieve more in less time.
            </motion.p>
            ...
            <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl border border-white/20 backdrop-blur-sm">
              ...
              >
                <div className="flex items-center gap-2">
                  <Icon icon="lucide:trending-up" className="text-primary text-xl" />
                  <div>
