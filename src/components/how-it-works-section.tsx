        ...
        <div className="flex flex-col gap-4 md:flex-row">
          <Accordion
            ...
            itemClasses={{
              base: "bg-content1",
              title: "text-lg",
              startContent: "text-xl text-primary-800",
            }}
            ...
            {steps.map(({ title, description, icon, index }) => (
              ...
              >
                ...
                <div className="hidden md:block">
                  ...
                  Lorem Ipsum sed do ut lorem tempor tempor magna ipsum do sit magna labore
                  incididunt dolore incididunt tempor magna do adipiscing magna adipiscing amet
                  lorem ipsum ipsum ipsum eiusmod labore sit eiusmod lorem
                </div>
                <div className="hidden lg:block">
                  adipiscing sed amet ut labore labore sit et dolor sed sit ut sit eiusmod amet
                  magna ut ut labore incididunt eiusmod tempor sed eiusmod do adipiscing eiusmod do
                  elit
                </div>
              </AccordionItem>
            ))}
          ...
          <div className="relative h-96 w-full overflow-hidden rounded-lg px-2 md:h-[500px] md:px-0">
